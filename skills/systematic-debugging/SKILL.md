...
3. **Check Recent Changes**
   ...
   - **OPTIONAL:** Invoke `snowball:recalling-project-context` scoped to the failing area — prior MADRs may document constraints or known pitfalls. When yactt has the repo indexed, `find_referencing_symbols` / `query_graph` on the failing symbol (after recall) can show inbound callers.
