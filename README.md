...
| VTCode                      | `.vtcode/AGENTS.md` (bootstrap mirror)                                                | project guidelines via `AGENTS.md`; skills symlinked into `.agents/skills/`; apply_patch observation+blast-radius hooks           | `AGENTS.md`                           |
